...
import { SelectWalletList } from "./select-wallet-list"
import { useClickOutside, useModal, useTheme } from "../../../hooks"

export const Modal = () => {
  const { isModalOpen, toggleModal, signers, selectSigner, selectCustomSigner, featuredSigner } =
    useModal()
      ...
      <Dialog.Root open={true}>
        <Dialog.Portal>
          ...
          >
            ...
            >
              <Header onBack={() => setIsViewAll(false)} isViewAll={isViewAll} />
              <SelectWalletList
