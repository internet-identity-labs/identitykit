...
Boolean representing wether identitykit initialized or not, includes validation of delegation
expiration for connected user on page reload (Connect wallet will be disabled until initialization
finishes).
