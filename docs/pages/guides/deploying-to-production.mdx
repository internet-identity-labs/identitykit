...
`your-canister-id.icp0.io` will ensure your users authenticate against that origin even if you
[change your frontend URL](/guides/configuring-custom-domains).
