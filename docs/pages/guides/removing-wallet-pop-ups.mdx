...
[ICRC-10](https://github.com/dfinity/ICRC/blob/main/ICRCs/ICRC-10/ICRC-10.md) describes the standard method
for simplifying the discovery of the supported standards of canisters on the Internet Computer.

List ICRC-28 and any other standards your canisters support.
