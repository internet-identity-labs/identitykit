...
The following guide teaches you how to execute canister transactions such that the `caller` is
your connected user.
...
Create an actor for the canister you want to call with the idlFactory you imported and its canister ID.
...
Use the Delegation Toolkit to [remove wallet approval pop-ups for executing calls to your canisters](./removing-wallet-pop-ups)
