...
This guide assumes you've already [configured your derivationOrigin](./deploying-to-production#derivationorigin-steps).
...
Follow [this documentation](https://internetcomputer.org/docs/current/developer-docs/web-apps/custom-domains/using-custom-domains) 
