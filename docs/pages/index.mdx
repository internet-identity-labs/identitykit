...
![Static Badge](https://img.shields.io/badge/version-1.0.17-blue)

![Static Badge](https://img.shields.io/badge/build-passing-brightgreen)

## The auth kit for ICP dApps

[NFID IdentityKit](https://qzjsg-qiaaa-aaaam-acupa-cai.icp0.io/) is a React library that makes it
...
[delegations](/miscellaneous/auth-options#account-delegations). Traditional Web3 UX requires users
...
[modal modes](/getting-started/featured-signer) - Featured and Compact - three
[color themes](/getting-started/theming) - light, dark, and system - and choose the
[order and display](/getting-started/signers-list) of the wallets you want to support.
...
Use the [interactive demo](https://qzjsg-qiaaa-aaaam-acupa-cai.icp0.io/demo) and get started with
