...
Calls made to smart contract canisters outside the whitelist will result in a wallet approval
...
IDs and follow the guide to [remove wallet approval pop-ups](/guides/removing-wallet-pop-ups).
