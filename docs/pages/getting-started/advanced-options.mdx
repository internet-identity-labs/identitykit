...
Defines the delegation's expiration duration in nanoseconds. 
This parameter is optional and defaults to **30 minutes** (`1_800_000_000_000` nanoseconds). 
It can be set to any valid `BigInt` value, depending on system requirements.  
