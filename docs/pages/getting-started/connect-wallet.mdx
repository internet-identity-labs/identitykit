...
This is the main component. It is responsible for rendering the connect/disconnect button. And it's
also possible to attach callbacks to react to successfull and failed connect or disconnect.
...
- ConnectWalletDropdownMenuItemInner
- ConnectWalletDropdownMenuAddressItem
- ConnectWalletDropdownMenuLogoutItem
  ...
  return (
    <ConnectWalletDropdownMenu>
      <ConnectWalletDropdownMenuButton
        as={({ className, children, ...props }: ConnectWalletDropdownMenuButtonProps) => (
          <ConnectedWalletButton
      ...
      />
      <ConnectWalletDropdownMenuItems>
        <ConnectWalletDropdownMenuLogoutItem onClick={disconnect} />
          <ConnectWalletDropdownMenuItem>
            <ConnectWalletDropdownMenuItemInner>
